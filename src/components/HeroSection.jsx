...
function HeroSection() {
  ...
  <h1 className="text-4xl sm:text-6xl lg:text-7xl text-center tracking-wide">
   VirTuLabVR build tools
   <span className="bg-gradient-to-r from-blue-500 to-blue-800 text-transparent bg-clip-text"> for developers</span>
  </h1>
  <p className='mt-10 text-lg text-center text-neutral-500 max-w-4xl'>
   Empower your creativity with our powerful tools and resources.
   Get started with VirTuLabVR today and turn your ideas into reality.
  </p>
...
<a href="#" className='py-3 px-4 mx-3 rounded-md border'>
  learn more
   ...
   <div className='flex mt-10 justify-center'>
    <video autoPlay loop muted className='w-1/2 rounded-lg border border-blue-700 shadow-blue-400 mx-2 my-4'>
