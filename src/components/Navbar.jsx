    ...
    <nav className='sticky top-0 z-50 py-3 backdrop-blur-md border-b border-neutral-700/80'>
     <div className="container px-4 mx-auto relative text-sm">
        <div className="container flex justify-between items-center">
            <div className="flex items flex-shrink-0">
                <img className='h-10 w-10 mr-2' src={logo} alt="Logo"  />
                <span className="span text-xl tracking-tight">VirTuLabVR</span>
            </div>
            ...
            <div className="hidden lg:flex justify-center space-x-12 items-center">
                ...
                <a href className='py-2 px-3 bg-blue-600 text-white rounded-md'>
                    Sign Up
                </a>
            </div>
